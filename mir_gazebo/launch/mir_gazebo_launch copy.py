...
def generate_launch_description():
    ...
    delayed_joint_state_broadcaster_spawner = RegisterEventHandler(
        event_handler=OnProcessStart(
            ...
            on_start=[joint_state_broadcaster_spawner],  # Updated reference
        )
    )
    ...
    OnProcessExit(  # Use OnProcessExit instead of OnProcessStart
    ...
    launch_rviz = Node(
        ...
        # output={'both': 'log'},
        output='screen',
        arguments=['-d', moveit_rviz_config_path], 
    ...
    # Use delayed spawning for proper controller initialization order
